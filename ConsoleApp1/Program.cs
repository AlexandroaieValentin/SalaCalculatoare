...
namespace SalaCalculatoare
{
    class Program
    {
        static void Main()
        {
            ...
            AdministrareCalculatoare admincalc = new AdministrareCalculatoare();
            Calculator calc1 = new Calculator();
            int indexcalc = 0;

            AdministrareSala adminsala = new AdministrareSala();
            Sala sala1 = new Sala();
        ...
        public static Sala CitireSalaTast()
        {
            ...
            Console.WriteLine("Numarul de camere din sala este: ");
            int nrcamere = Convert.ToInt32(Console.ReadLine());
            Sala sala1 = new Sala(capacitate, nrcamere);
            return sala1;
        }
        public static void AfisareSala(Sala sala1)
        {
            string InfoSala = string.Format("Sala are capacitatea maxima: {0}, iar numarul de camere este {1}. ",
                sala1.capacitate,
                sala1.nrcamere);
